...
public class MyAnswerFragment extends Fragment {
    ...
    private void init() {
        ...
        tvEmptyState.setText("You have not answered any question.");
    ...
    private void onDataRefresh() {
        ...
        Call<ResultEntity> call = apiInterface.getAnswer("me", "0", questionList.get(0).getQuestionId(), "", PreferenceHelper.getToken(getActivity()));
    ...
    private void getQuestionAnswer() {
        ...
        ApiInterface apiInterface = ApiClientForQna.getClient().create(ApiInterface.class);
        Call<ResultEntity> call = apiInterface.getAnswer("me", "0", "", "", PreferenceHelper.getToken(getActivity()));
        call.enqueue(new Callback<ResultEntity>() {
            @Override
            public void onResponse(Call<ResultEntity> call, Response<ResultEntity> response) {
                //HelperClass.displayRequestAndResponse(response, null);
    ...
    private void setAnswerInList(final List<QuestionData> qnaList) {
        llProgress.setVisibility(View.GONE);
    ...
    private void getLoadMoreQuestionAnswer() {
        ...
        ApiInterface apiInterface = ApiClientForQna.getClient().create(ApiInterface.class);
        Call<ResultEntity> call = apiInterface.getAnswer("me", "" + paging, "", "", PreferenceHelper.getToken(getActivity()));
        call.enqueue(new Callback<ResultEntity>() {
            @Override
            public void onResponse(Call<ResultEntity> call, Response<ResultEntity> response) {
                //HelperClass.displayRequestAndResponse(response, null);
