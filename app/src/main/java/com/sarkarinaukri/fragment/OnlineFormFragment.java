...
public class OnlineFormFragment extends Fragment {
    ...
    private void init() {
        ...
        tvViewAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                HelperClass.openUrlInChromeCustomTab(getActivity(), "https://www.sarkariexam.com/category/top-online-form");
            }
        });
    }
    ...
    private void getDataListFromFirebase() {
        ...
        if (currentLanguage.equalsIgnoreCase(Constant.ENGLISH)) {
            call = apiInterface.getJobs("top_online_form");
        } else {
            call = apiInterface.getJobs("hindi_top_online_form");
        }
        call.enqueue(new Callback<ResultEntity>() {
            ...
            public void onResponse(Call<ResultEntity> call, Response<ResultEntity> response) {
                ...
                if (response.code() == 200) {
                    ...
                    jobList = resultEntity.getTop_online_form();
                    setDataListInAdapter();
                }
            }
