...
public class BtechJobsFragment extends Fragment {
    private View view;
    ...
    private void init() {
        ...
        tvViewAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                HelperClass.openUrlInChromeCustomTab(getActivity(), "https://www.sarkariexam.com/category/b-tech-m-tech");
            }
        });
    }
    ...
    private void getDataListFromFirebase() {
        ...
        Call<ResultEntity> call = apiInterface.getJobs("b_tech_m_tech");
        call.enqueue(new Callback<ResultEntity>() {
            ...
            public void onResponse(Call<ResultEntity> call, Response<ResultEntity> response) {
                ...
                if (response.code() == 200) {
                    ...
                    jobList = resultEntity.getB_tech_m_tech();
                    setDataListInAdapter();
                }
            }
