...
public class ResultFragment extends Fragment {
    ...
    private void init() {
        ...
        tvViewAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                HelperClass.openUrlInChromeCustomTab(getActivity(), "https://www.sarkariexam.com/category/exam-result");
            }
        });
    }
    ...
    private void getDataListFromFirebase() {
        ...
        if (currentLanguage.equalsIgnoreCase(Constant.ENGLISH)) {
            call = apiInterface.getJobs("exam_result");
        } else {
            call = apiInterface.getJobs("hindi_exam_result");
        }
        call.enqueue(new Callback<ResultEntity>() {
            ...
            public void onResponse(Call<ResultEntity> call, Response<ResultEntity> response) {
                ...
                if (response.code() == 200) {
                    ...
                    jobList = resultEntity.getExam_result();
                    setDataListInAdapter();
                }
            }
