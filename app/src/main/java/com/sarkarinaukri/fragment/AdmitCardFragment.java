...
public class AdmitCardFragment extends Fragment {
    ...
    private void init() {
        ...
        tvViewAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                HelperClass.openUrlInChromeCustomTab(getActivity(), "https://www.sarkariexam.com/category/admit-card");
            }
        });
    }
    ...
    private void getDataListFromFirebase() {
        ...
        if (currentLanguage.equalsIgnoreCase(Constant.ENGLISH)) {
            call = apiInterface.getJobs("admit_card");
        } else {
            call = apiInterface.getJobs("hindi_admit_card");
        }
        call.enqueue(new Callback<ResultEntity>() {
            ...
            public void onResponse(Call<ResultEntity> call, Response<ResultEntity> response) {
                ...
                if (response.code() == 200) {
                    ...
                    jobList = resultEntity.getAdmit_card();
                    setDataListInAdapter();
                }
            }
