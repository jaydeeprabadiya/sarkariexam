...
public class SyllabusFragment extends Fragment {
    ...
    private void init() {
        ...
        tvViewAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                HelperClass.openUrlInChromeCustomTab(getActivity(), "https://www.sarkariexam.com/category/syllabus");
            }
        });
    }
    ...
    private void getDataListFromFirebase() {
        ...
        Call<ResultEntity> call = apiInterface.getJobs("syllabus");
        call.enqueue(new Callback<ResultEntity>() {
            ...
            public void onResponse(Call<ResultEntity> call, Response<ResultEntity> response) {
                ...
                if (response.code() == 200) {
                    ...
                    jobList = resultEntity.getSyllabus();
                    setDataListInAdapter();
                }
            }
